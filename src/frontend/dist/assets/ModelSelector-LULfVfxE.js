import { r as reactExports, t as useControllableState, j as jsxRuntimeExports, R as Root2$1, v as useId, w as useComposedRefs, x as Primitive, y as composeEventHandlers, z as Anchor, D as Presence, E as Portal$1, G as createPopperScope, H as createContextScope, I as createSlot, J as DismissableLayer, K as Content, N as Arrow, g as cn, b as Button, A as AiModel } from "./index-Dcr_jcQM.js";
import { B as Badge } from "./badge-D5uulW1x.js";
import { h as hideOthers, R as ReactRemoveScroll, u as useFocusGuards, F as FocusScope, C as Check } from "./Combination-t0jS6oQ9.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Popover, { open, onOpenChange: setOpen, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PopoverTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Button,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: cn("font-semibold", selected.color), children: selected.label }),
          !compact && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground text-xs", children: selected.provider }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "size-3 text-muted-foreground ml-auto" })
        ]
      }
    ) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      PopoverContent,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wider px-2 py-1.5", children: "Choose a model" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-0.5", children: MODEL_OPTIONS.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-0.5", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: cn("text-sm font-semibold", m.color), children: m.label }),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground leading-relaxed", children: m.description })
                ] }),
                value === m.id && /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "size-4 text-primary mt-0.5 shrink-0" })
              ]
            },
            m.id
          )) })
